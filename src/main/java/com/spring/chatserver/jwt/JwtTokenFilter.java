...
import com.spring.chatserver.service.ServiceImpl.UserServiceImpl;
...
public class JwtTokenFilter extends OncePerRequestFilter {
	...
	public JwtTokenFilter(JwtTokenUtil jwtUtil, UserServiceImpl userServiceImpl) {
    ...
    private void setAuthenticationContext(String token, HttpServletRequest request) {
        ...
        UserDto user = userServiceImpl.getUserDetails(userId);
